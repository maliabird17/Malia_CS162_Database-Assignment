...
print('Commission data (now stored in a new table):')
...
print('Days on the market for home sales this month:')
...
print('Average selling price for homes sold this month:')
